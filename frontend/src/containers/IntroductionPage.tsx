          ...
          <div className="flex flex-row py-7 overflow-hidden rounded-3xl">
            ...
            <div className="flex flex-col flex-1">
              <div className="flex justify-center m-3">
                <img src="https://i.imgur.com/bDLhJiP.jpg" width="100" className="rounded-full justify-center" />
              </div>
              <div className="text-center my-3">
                <span className="bg-slate-400 p-1 px-4 rounded text-white">Pro</span>
                ...
                <div className="flex flex-row justify-center space-x-6">
                  ...
                  >
                  <img src={facebookURL} alt="instagram link" className="w-6 h-6" />
                  </a>
                  <a
                  ...
                  className="text-gray-400 hover:text-gray-500"
                  >
                  <img src={githubURL} alt="instagram link" className="w-6 h-6" />
                  </a>
                </div>
              </div>
            </div>
