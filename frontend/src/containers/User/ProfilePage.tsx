...
import { ALL_USERS_QUERY, UPDATE_USER_MUTATION, UPDATE_USER_PROFILE_MUTATION } from "../../graphql";
            ...
            <div className="flex flex-row w-fit">
                ...
                <div className="col-md-5 border-right">
                    <div className="p-3 py-5">
                        {!edit && <button className="text-md font-bold bg-blue-700 mt-0 text-white px-4 py-1 rounded hover:bg-blue-700 mr-2 " 
                        ...
                        {edit && <textarea value={intro} onChange={(event)=>{setIntor(event.target.value)}}></textarea>}
                        <div className="flex mt-2">
                            <span className="bg-slate-400 p-1 px-4 rounded text-white center">
                                StudentId
                            </span>
                        ...
                        {!edit && <p className="p-1 px-4 rounded">https://www.google.com/</p>}
                        {edit &&
                        <input
                            className="p-1 px-4 rounded"
                            type="text"
